    ...
    <View style={styles.container}>
      ...
      >
        <View className="bg-[#181524] border border-white/10 rounded-2xl p-5 items-center justify-center">
          <View className="w-14 h-14 rounded-2xl bg-[#f472b6]/20 items-center justify-center mb-3 border border-[#f472b6]/30">
            <ShieldAlert size={28} color="#f472b6" />
          </View>
          <Text className="text-white text-lg font-black text-center mb-1">Exam Invigilation Screen</Text>
          <Text className="text-white/60 text-xs text-center leading-relaxed">
            Ready to configure invigilation duties, check-in reporting, hall seating allocations, and partner assignments.
          </Text>
        </View>
      </ScrollView>
    </View>
