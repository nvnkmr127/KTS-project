        ...
        >
          ...
          <View className="flex-row pt-4 border-t border-white/10" style={{ gap: 12 }}>
            ...
            <Pressable
              ...
              className={`flex-1 ${primaryBtnClass} py-3.5 rounded-xl items-center shadow-lg`}
            >
              <Text className="text-[#101415] font-bold text-sm">{isEdit ? "Save Changes" : "Add Student"}</Text>
            </Pressable>
          </View>
        </GlassCard>
        </ScrollView>
