...
export function StaffFilters({ search, setSearch, deptFilter, setDeptFilter, catFilter, setCatFilter, statusFilter, setStatusFilter, allCategories }: StaffFiltersProps) {
  return (
    <>
