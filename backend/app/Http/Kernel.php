...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'dashboard.cache' => \App\Http\Middleware\DashboardCacheMiddleware::class,
        'dashboard.maintenance' => \App\Http\Middleware\DashboardMaintenanceMiddleware::class,
        'dashboard.throttle' => \App\Http\Middleware\DashboardThrottleMiddleware::class,
        'widget.permission' => \App\Http\Middleware\WidgetPermissionMiddleware::class,
