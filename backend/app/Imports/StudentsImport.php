...
class StudentsImport implements SkipsOnFailure, ToModel, WithHeadingRow, WithValidation
{
    ...
    private function applyConcessionToTuitionFees(Student $student, array $tuitionFees, $totalConcession)
    {
        ...
        $tuitionFeeAmount = array_sum(array_map(function ($fee) {
            return $fee->amount;
        }, $tuitionFees));
    ...
    public function getRejectedRows(): array
    {
        return $this->rejectedRows;
    }

    public function getFeeComponentsCreated(): int
    {
        return $this->feeComponentsCreated;
    }

    public function getFeeComponentErrors(): array
    {
        return $this->feeComponentErrors;
    }

    public function getPaymentsCreated(): int
    {
